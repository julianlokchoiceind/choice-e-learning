...
const CoursePreviewTab: FC<CoursePreviewTabProps> = ({ course }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-800">Course Review</h2>
      </div>
              ...
              {lessons.length > 0 ? (
                <div className="space-y-2 max-h-60 overflow-y-auto">
                  {lessons.map((lesson, index) => (
                    <div key={lesson.id} className="flex items-center justify-between p-2 bg-white rounded">
              ...
              <div className="bg-gray-50 rounded-lg border border-gray-100 p-6">
                ...
                {quizzes.length > 0 ? (
                  <div className="space-y-2 max-h-32 overflow-y-auto">
                    {quizzes.map((quiz) => (
                      <div key={quiz.id} className="flex items-center justify-between p-2 bg-white rounded">
                ...
                {materials.length > 0 ? (
                  <div className="space-y-2 max-h-32 overflow-y-auto">
                    {materials.map((material) => (
                      <div key={material.id} className="flex items-center space-x-2 p-2 bg-white rounded">
