    ...
    try {
      ...
      return {
        ...
        error: apiError(
          ...
          ApiErrorCode.REQUEST_PARSE_ERROR,
          400
        )
      };
    }
...
/**
 * Parse and validate URL search params with enhanced type safety
 * @param req Next.js request object
 * @param schema Zod schema for query parameters with proper typing
 * @returns Validated query parameters or error
 */
export function parseQueryParams<Output, Input = Output>(
  req: NextRequest,
